      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-xl font-bold">
                Markdown<span className="text-primary-400">PDF</span>
              </span>
            </div>
            <p className="text-slate-400 text-sm leading-relaxed">
              现代化 Markdown 编辑器，让你的文档创作更加高效便捷。
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-slate-400">
              <li>
                <a href="https://www.markdownguide.org" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                  Markdown 指南
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-slate-400 text-sm">
            © 2026 MarkdownPDF. All rights reserved.
          </p>
